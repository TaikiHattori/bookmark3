...
$sql = 'SELECT * FROM session_login_users_table WHERE username=:username AND password=:password AND deleted_at IS NULL';
...
if (!$user) {
    ...
    echo "<a href=work_picture_login.php>ログイン</a>";
    exit();
} else {
    $_SESSION = array();
